...
import FireBall from '../objects/fire-ball';
...
export class GameScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    // set collision for tiles with the 1operty collide set to true
    ...
    this.physics.add.collider(this.fireBalls,this.foregroundLayer);
    ...
    this.events.on('fire!',(fireBall:FireBall) => {
  ...
  private handlePlayerEnemyOverlap(_player: Mario, _enemy: Goomba): void {
    ...
    /**
   * Player <-> Enemy Overlap
   * @param _fireball [FireBall]
   * @param _enemy  [Enemy]
   */
     private handleFireBallEnemyOverlap(_fireball: FireBall, _enemy: Goomba): void {
